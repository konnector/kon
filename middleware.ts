...
// List of allowed file extensions for static files
const ALLOWED_FILE_EXTENSIONS = ['.ico', '.svg', '.png', '.jpg', '.jpeg', '.gif', '.json'];
...
export async function middleware(req: NextRequest) {
  ...
  // Allow all API routes, static files, and files with allowed extensions
  if (
