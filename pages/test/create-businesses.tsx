  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-md mx-auto space-y-4">
        ...
        {success && (
          <Alert>
            Successfully created test businesses!
          </Alert>
        )}
        ...
        <Button 
          ...
          className="w-full"
        >
          {loading ? 'Creating Test Businesses...' : 'Create Test Businesses'}
        </Button>
        
        <p className="text-sm text-muted-foreground text-center">
          This will create test business profiles in your database and update the spreadsheet.
        </p>
      </div>
    </div>
  );
